...
function updateCartUI() {
    ...
    if (cart.length === 0) {
        cartItems.innerHTML = '<p style="text-align: center; color: var(--text-secondary); padding: 2rem;">Кошик порожній</p>';
...
function completeOrder() {
    ...
    send(JSON.stringify({ name : name, email : email, cart : JSON.stringify(cart)}));
